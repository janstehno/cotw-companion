...
class ActivityDetailAnimalState extends State<ActivityDetailAnimal> {
          ...
          child: Stack(fit: StackFit.expand, children: [
            /*OrientationBuilder(builder: (context, orientation) {
              return LimitedBox(
                maxHeight: size,
                child: Image.asset(
                  Graphics.getAnimalBackground(widget.animalId),
            ...
            Container(
                ...
                child: Row(mainAxisSize: MainAxisSize.max, mainAxisAlignment: MainAxisAlignment.spaceBetween, crossAxisAlignment: CrossAxisAlignment.center, children: [
                  Row(mainAxisSize: MainAxisSize.max, mainAxisAlignment: MainAxisAlignment.start, crossAxisAlignment: CrossAxisAlignment.center, children: [
                    ...
                    (widget.animalId > 80 && _animal.trophy > 0)
                        ? Container(
                            margin: const EdgeInsets.only(bottom: 1.5),
                            child: Text(
                              "?",
  ...
  Widget _buildZones() {
    return Column(children: [
      ...
      ListAnimalZones(animalId: widget.animalId, reserveId: widget.reserveId),
    ]);
  }
  ...
  Widget _buildAnatomy() {
    return _animal.level > 1
        ? Column(children: [
            ...
            Stack(children: [
              SvgPicture.asset(
                Graphics.getAnatomyAsset(widget.animalId, AnatomyPart.body),
                fit: BoxFit.fitWidth,
                colorFilter: ColorFilter.mode(
              ...
              SvgPicture.asset(
                Graphics.getAnatomyAsset(widget.animalId, AnatomyPart.organs),
                fit: BoxFit.fitWidth,
              )
            ])
          ])
