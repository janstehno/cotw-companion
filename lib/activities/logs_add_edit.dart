    ...
    for (int index = 0; index < HelperJSON.reserves.length; index++) {
      dropItems.add(DropdownMenuItem(
          ...
          child: AnimatedContainer(
              ...
              child: AutoSizeText(
                HelperJSON.reserves[index].getName(context.locale),
                maxLines: 1,
    ...
    for (int index = 0; index < _animals.length; index++) {
      dropItems.add(DropdownMenuItem(
          ...
          child: AnimatedContainer(
              ...
              alignment: Alignment.centerLeft,
              child: AutoSizeText(
                _animals[index].getNameBasedOnReserve(context.locale, _selectedReserveId),
                maxLines: 1,
                style: Interface.s16w300n(Interface.dark),
              ))));
    }
    ...
    for (int index = 0; index < _furs.length; index++) {
      dropItems.add(DropdownMenuItem(
          ...
          child: AnimatedContainer(
              ...
              alignment: Alignment.centerLeft,
              child: AutoSizeText(
                _furs[index].getName(context.locale),
                maxLines: 1,
                style: Interface.s16w300n(Interface.dark),
              ))));
    }
