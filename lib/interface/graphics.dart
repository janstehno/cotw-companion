...
class Graphics {
  static final Map<String, String> _animals = {
    ...
    "ANIMAL:AMERICAN_MINK": Assets.graphics.animals.americanmink,
    ...
    "ANIMAL:BLACK_CAIMAN": Assets.graphics.animals.blackcaiman,
    ...
    "ANIMAL:CAPYBARA": Assets.graphics.animals.capybara,
    ...
    "ANIMAL:EURASIAN_PINE_MARTEN": Assets.graphics.animals.eurasianpinemarten,
    "ANIMAL:EURASIAN_TEAL": Assets.graphics.animals.eurasianteal,
    "ANIMAL:EURASIAN_WIGEON": Assets.graphics.animals.eurasianwigeon,
    "ANIMAL:EURASIAN_WOODCOCK": Assets.graphics.animals.eurasianwoodcock,
    "ANIMAL:EUROPEAN_BADGER": Assets.graphics.animals.europeanbadger,
    ...
    "ANIMAL:GREATER_GRISON": Assets.graphics.animals.greatergrison,
    ...
    "ANIMAL:JAGUAR": Assets.graphics.animals.jaguar,
    ...
    "ANIMAL:OCELOT": Assets.graphics.animals.ocelot,
    ...
    "ANIMAL:RED_GROUSE": Assets.graphics.animals.redgrouse,
    ...
    "ANIMAL:SOUTH_AMERICAN_TAPIR": Assets.graphics.animals.southamericantapir,
    "ANIMAL:SOUTHEASTERN_SPANISH_IBEX": Assets.graphics.animals.southeasternspanishibex,
    "ANIMAL:SPECTACLED_BEAR": Assets.graphics.animals.spectacledbear,
    ...
    "ANIMAL:TARUCA": Assets.graphics.animals.taruca,
    ...
    "ANIMAL:VICUNA": Assets.graphics.animals.vicuna,
    ...
    "ANIMAL:WESTERN_MOUNTAIN_COATI": Assets.graphics.animals.westernmountaincoati,
  ...
  static final Map<String, String> _heads = {
    ...
    "ANIMAL:AMERICAN_MINK": Assets.graphics.heads.americanmink.path,
    ...
    "ANIMAL:BLACK_CAIMAN": Assets.graphics.heads.blackcaiman.path,
    ...
    "ANIMAL:CAPYBARA": Assets.graphics.heads.capybara.path,
    ...
    "ANIMAL:EURASIAN_PINE_MARTEN": Assets.graphics.heads.eurasianpinemarten.path,
    ...
    "ANIMAL:EURASIAN_WOODCOCK": Assets.graphics.heads.eurasianwoodcock.path,
    "ANIMAL:EUROPEAN_BADGER": Assets.graphics.heads.europeanbadger.path,
    ...
    "ANIMAL:GREATER_GRISON": Assets.graphics.heads.greatergrison.path,
    ...
    "ANIMAL:JAGUAR": Assets.graphics.heads.jaguar.path,
    ...
    "ANIMAL:OCELOT": Assets.graphics.heads.ocelot.path,
    ...
    "ANIMAL:RED_GROUSE": Assets.graphics.heads.redgrouse.path,
    ...
    "ANIMAL:SOUTH_AMERICAN_TAPIR": Assets.graphics.heads.southamericantapir.path,
    "ANIMAL:SOUTHEASTERN_SPANISH_IBEX": Assets.graphics.heads.southeasternspanishibex.path,
    "ANIMAL:SPECTACLED_BEAR": Assets.graphics.heads.spectacledbear.path,
    ...
    "ANIMAL:TARUCA": Assets.graphics.heads.taruca.path,
    ...
    "ANIMAL:VICUNA": Assets.graphics.heads.vicuna.path,
    ...
    "ANIMAL:WESTERN_MOUNTAIN_COATI": Assets.graphics.heads.westernmountaincoati.path,
  ...
  static final Map<String, String> _anatomy = {
    ...
    "ANIMAL:BLACK_CAIMAN": Assets.graphics.anatomy.blackCaiman.path,
    ...
    "ANIMAL:CAPYBARA": Assets.graphics.anatomy.capybara.path,
    ...
    "ANIMAL:EUROPEAN_BADGER": Assets.graphics.anatomy.europeanBadger.path,
    ...
    "ANIMAL:JAGUAR": Assets.graphics.anatomy.jaguar.path,
    ...
    "ANIMAL:OCELOT": Assets.graphics.anatomy.ocelot.path,
  ...
  static final Map<String, String> _reserves = {
    ...
    "RESERVE:INTISUYU_HUNTING_RESERVE": Assets.graphics.reserves.intisuyuhuntingreserve,
    ...
    "RESERVE:TORR_NAN_SITHEAN_HUNTING_ESTATE": Assets.graphics.reserves.torrnansitheanhuntingestate,
  ...
  static final Map<String, String> _weapons = {
    ...
    "WEAPON:BENELHAG_12G": Assets.graphics.weapons.benelhag12g,
    ...
    "WEAPON:DAHLER_REVERSE_DRAW_CB150": Assets.graphics.weapons.dahlerrecurvedrawcb150,
