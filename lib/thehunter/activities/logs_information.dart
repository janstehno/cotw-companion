        ...
        children: [
          ...
          Container(
              ...
              child: Column(children: [
                ...
                Container(alignment: Alignment.centerLeft, padding: const EdgeInsets.only(left: 30, right: 30), child: WidgetRichText(text: tr('logbook_info_6_1')))
              ])),
          Container(
              padding: const EdgeInsets.only(top: 20),
              child: Column(children: [
                EntryIconName(text: tr('logbook_info_7'), icon: "assets/graphics/icons/edit.svg"),
                Container(alignment: Alignment.centerLeft, padding: const EdgeInsets.only(left: 30, right: 30), child: WidgetRichText(text: tr('logbook_info_7_1')))
              ])),
          Container(
              padding: const EdgeInsets.only(top: 20),
              child: Column(children: [
                ...
                Container(
                    alignment: Alignment.centerLeft, padding: const EdgeInsets.only(left: 30, right: 30, top: 10), child: WidgetRichText(text: tr('logbook_info_5_2')))
              ])),
          Container(
              padding: const EdgeInsets.only(top: 20),
              child: Column(children: [
                ...
                Container(
                    alignment: Alignment.centerLeft, padding: const EdgeInsets.only(left: 30, right: 30, top: 10), child: WidgetRichText(text: tr('logbook_info_2_2'))),
                Container(
                    alignment: Alignment.centerLeft, padding: const EdgeInsets.only(left: 30, right: 30, top: 10), child: WidgetRichText(text: tr('logbook_info_2_3'))),
                Container(
                    alignment: Alignment.centerLeft, padding: const EdgeInsets.only(left: 30, right: 30, top: 10), child: WidgetRichText(text: tr('logbook_info_2_4'))),
                Container(
                    alignment: Alignment.centerLeft, padding: const EdgeInsets.only(left: 30, right: 30, top: 10), child: WidgetRichText(text: tr('logbook_info_2_5'))),
                Container(
                    alignment: Alignment.centerLeft, padding: const EdgeInsets.only(left: 30, right: 30, top: 10), child: WidgetRichText(text: tr('logbook_info_2_6'))),
                Container(
                    alignment: Alignment.centerLeft, padding: const EdgeInsets.only(left: 30, right: 30, top: 10), child: WidgetRichText(text: tr('logbook_info_2_7')))
              ])),
          Container(
              padding: const EdgeInsets.only(top: 20),
              child: Column(children: [
          ...
          Container(
              ...
              child: Column(children: [
                ...
                Container(
                    alignment: Alignment.centerLeft, padding: const EdgeInsets.only(left: 30, right: 30, top: 10), child: WidgetRichText(text: tr('logbook_info_8_3'))),
                Container(
                    alignment: Alignment.centerLeft, padding: const EdgeInsets.only(left: 30, right: 30, top: 10), child: WidgetRichText(text: tr('logbook_info_8_4')))
              ])),
